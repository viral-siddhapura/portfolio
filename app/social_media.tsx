...
export default function SocialMedia() {
    return (
        <div className='flex flex-row space-x-4 md:space-x-4 lg:space-x-4 sm:space-x-4 xl:space-x-4 2xl:space-x-4 mx-5 sm:mx-10 md:mx-20 lg:mx-80 p-2 sm:p-3 md:p-4 lg:p-5'>
            {/* Github Button */}
            <div>
            ...
            <div>
                <Link href="https://www.instagram.com/viru_1116/" target="_blank" rel="noopener noreferrer">
                    <button
                        type="button"
                        className="rounded-full p-3.5 hover:shadow-lg hover:shadow-rose-500"
